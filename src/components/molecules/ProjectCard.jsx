...
function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 my-2 text-center">
        {title}
      </h3>
      ...
      <div className="flex flex-wrap justify-center gap-1.5 my-2 max-w-full">
        {tags.map((tag) => (
          <Chip
            key={tag}
            size="sm"
