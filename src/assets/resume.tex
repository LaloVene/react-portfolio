...
\textbf{AI \& Data:} PyTorch, LangGraph, LangChain, RAG, Knowledge Graphs, MCP, Hugging Face, TensorFlow, Vector DB, SQL \\
...
\begin{itemize}
  ...
  \item \textbf{Led the design} of an evaluation framework for precise failure localization.
  \item Developed a scalable \textbf{synthetic benchmark generation pipeline} for evaluating multi-turn agentic conversations.
  \item Built an \textbf{unsupervised auditing framework} to evaluate RAG deployments across more than \textbf{4 million corporate records}.
\end{itemize}
...
\begin{itemize}
  \item Coursing: \textit{Statistics}, \textit{ML Cybersecurity}, \textit{NLP}, \textit{Machine Translation}, \textit{Quantum AI}, \textit{Image Processing \& Computer Vision}.
